...
object StepOperators {
  ...
  implicit class Apply1OperatorConverter[I](val parent: OptionStep[I]) extends AnyVal {
    def |>[O](mapper: StepIO[I] => StepIO[O]): Apply1Step[I, O] = new Apply1Step(parent, mapper)
  }

  implicit class Apply2OperatorConverter[I1, I2](val parents: (OptionStep[I1], OptionStep[I2])) extends AnyVal {
    def |>[O](zipper: (StepIO[I1], StepIO[I2]) => StepIO[O]): Apply2Step[I1, I2, O] = new Apply2Step(parents, zipper)
  }

  implicit class Apply3OperatorConverter[I1, I2, I3](val parents: (OptionStep[I1], OptionStep[I2], OptionStep[I3])) extends AnyVal {
