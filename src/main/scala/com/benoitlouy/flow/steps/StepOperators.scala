...
//    def map[O](mapper: => (Option[I] => Option[O])): Zip1Step[I, O] = map(mapper)
  ...
  implicit class Zip2OperatorConverter[I1, I2](val parents: (OptionStep[I1], OptionStep[I2])) extends AnyVal {
    ...
    def zip[O](zipper: => ((ValidationNelException[I1], ValidationNelException[I2]) => ValidationNelException[O])): Zip2Step[I1, I2, O] = zip(zipper)
  }
  ...
  implicit class Zip3OperatorConverter[I1, I2, I3](val parents: (OptionStep[I1], OptionStep[I2], OptionStep[I3])) extends AnyVal {
    ...
    def zip[O](zipper: => ((ValidationNelException[I1], ValidationNelException[I2], ValidationNelException[I3]) => ValidationNelException[O])): Zip3Step[I1, I2, I3, O] = zip(zipper)
  }
}
